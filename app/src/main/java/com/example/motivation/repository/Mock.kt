...
class Mock {
    private val ALL = MotivationConstants.PHRASEFILTERS.ALL
    private val HAPPY = MotivationConstants.PHRASEFILTERS.HAPPY
    private val MORNING = MotivationConstants.PHRASEFILTERS.MORNING
